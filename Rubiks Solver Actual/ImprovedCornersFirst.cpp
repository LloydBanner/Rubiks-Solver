...
ImprovedCornersFirst::ImprovedCornersFirst() {
}

void ImprovedCornersFirst::solveBottomCorners() {
...
void ImprovedCornersFirst::solveTopCorners() {
...
void ImprovedCornersFirst::solveThreeLedges() {
	//left edges
...
void ImprovedCornersFirst::solveRedges() {
	//Right edges
...
void ImprovedCornersFirst::solveLastLedge() {
	//last left edge
	for (int i = 0; i < 4; i++) {
...
void ImprovedCornersFirst::flipMidges() {
...
void ImprovedCornersFirst::completeCube() {
	for (int i = 0; i < 8; i++) {
...
bool ImprovedCornersFirst::isSolutionValid() {
	bool valid = true;
...
void ImprovedCornersFirst::setCube(RubiksCube cube) {
	cubeToSolve = cube;
}

RubiksCube ImprovedCornersFirst::getCube() {
	return cubeToSolve;
}
